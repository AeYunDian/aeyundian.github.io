...
export const LinkPresets: Record<LinkPreset, NavBarLink> = {
  ...
  [LinkPreset.cookiePolicy]: {
    name: i18n(I18nKey.cookiePolicy),
    url: "/cookie_policy/",
    icon: "material-symbols:psychology",
  },
  [LinkPreset.privacyPolicy]: {
    name: i18n(I18nKey.privacyPolicy),
    url: "/privacy_policy/",
    icon: "material-symbols:timeline",
  },
  [LinkPreset.termsOfService]: {
    name: i18n(I18nKey.termsOfService),
    url: "/terms/",
    icon: "material-symbols:smart-toy",
  },
};
