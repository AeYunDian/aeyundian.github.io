...
next: false
---
适用于触屏和鼠标的简易绘图软件。 [安装包下载](/aycanvars/download/release/1.2.0.exe)
<!-- more -->
## 简介
...
- 日志：自研 LogFile
- 安装包：Inno Setup，大小约2.26 MB，实际程序大小约124 KB

## 下载与安装

当前版本：v1.2.0（2026-04-08）
[下载链接](/aycanvars/download/release/1.2.0.exe)
