...
export default {
    ...
    methods: {
        ...
        async checkRisksAndInit() {
            ...
            const isLocalhost = ['localhost', '127.0.0.1', '::1'].some(host => window.location.hostname.includes(host)) || window.location.hostname.startsWith('192.168') || window.location.hostname.startsWith('192.168.')
